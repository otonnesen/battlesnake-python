...
# TODO: Implement safety check on each tile (How many turns away is an unavoidable death?)
...
# Initial findings: Maximum reasonalbe depth (<200ms runtime) is 12 to 13 (The algorithm seems to run in upwards of O(n^6) or O(n^7) time)
...
for i in range(10):
    test = []
    findPath(game_board, game_board.you['body']['data'][0])
    print(test)
'''
